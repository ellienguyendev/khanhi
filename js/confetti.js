...
///////// MY CODE ////////////
	...
	function flipCards() {
	  ...
	  if (this.classList.contains('1')) {
	    ...
	    click++
		 ...
		 this.classList.add('newPics')
		 click++
	 } else if (this.classList.contains('8')) {
		 this.src = 'pics/h.png'
		 this.classList.add('flipped')
		 this.classList.add('newPics')
		 click++
	...
	function checkCards(c1, c2) {
		var logo1 = c1.className.split()[0][0]
		var logo2 = c2.className.split()[0][0]
	  c1.classList.remove('flipped')
	  c2.classList.remove('flipped')
	  if (c1.className != c2.className) {
	    c1.src = `pics/logo${logo1}.png`
	    c2.src = `pics/logo${logo2}.png`
	    c1.classList.remove('newPics')
	    c2.classList.remove('newPics')
	  }
	  else{
	    win +=10
	    console.log("match")
	  ...
	  if(win===80){
			alert("Happy Birthday Lilly! Here are 16 things I love about you!")
			startConfetti(3000)
			var main = document.querySelector('.main')
			var afterWin = document.querySelector('.afterWin')
